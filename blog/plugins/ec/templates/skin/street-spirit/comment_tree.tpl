...
<div class="comments-header">
	<h3>{$aLang.comment_title} (<span id="count-comments">{$iCountComment}</span>)
	{if $sTargetType=='topic'}<a href="{router page='rss'}comments/{$iTargetId}/" class="rss"></a>{/if}
    {if count($aComments) > 0}
	<span class="commens-header-slider">
