...
{else}
	{if $oUserCurrent}
		...
		{include file="$sTPEc/comment_edit_form.tpl"}
		...
		<div id="reply_0" class="reply">
			...
			<form action="" method="POST" id="form_comment" onsubmit="return false;" enctype="multipart/form-data">
				...
				<input type="button" class="submit" value="{$aLang.comment_preview}" onclick="ls.comments.preview();" />
				<input type="submit" class="submit" name="submit_comment" value="{$aLang.comment_add}" id="comment-button-submit" onclick="ls.comments.add('form_comment',{$iTargetId},'{$sTargetType}'); return false;" />
