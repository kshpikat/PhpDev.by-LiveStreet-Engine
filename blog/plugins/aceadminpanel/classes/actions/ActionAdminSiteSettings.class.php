...
class PluginAceadminpanel_AdminSiteSettings extends AceAdminPlugin
{
    ...
    public function Event()
    {
        ...
        //var_dump($aConfigSet = $this->PluginAceadminpanel_Admin_GetValueArrayByPrefix('config.all.')) ;
        //var_dump(Config::Get($this->sPlugin . '.saved'));        exit;

        //{assign var="sValue" value=$oConfig->GetValue("`$sSavedPrefix`.`$aItem.config`")}
        //{if $sValue==null}{assign var="sValue" value=$oConfig->GetValue("`$aItem.config`")}{/if}
