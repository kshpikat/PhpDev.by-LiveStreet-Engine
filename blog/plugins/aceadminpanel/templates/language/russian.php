...
return array(
    ...
    'adm_user_ip_seek_notice' => 'Например, 83.167.100.46 или 83.167.*.* ',
    'adm_user_regdate_seek_notice' => 'Например, 2009-2 или 2009-3-31',

    'adm_button_report' => 'Сформировать отчет',
    'adm_button_checkin' => 'Включить в отчет',

    'adm_menu_about' => 'Информация',
    ...
    'adm_menu_users_profile' => 'Профиль',
    ...
    'adm_users_del_warning' => 'ВНИМАНИЕ! Удаляя пользователя, Вы удалите ВСЕ его блоги, топики, комментарии, голосования. Могут быть удалены также комментарии других пользователей, написанные в ответ на удаляемые комментарии',
    'adm_users_del_confirm' => 'Подтвердите удаление пользователя',
    ...
    'adm_user_voted_users' => 'За пользователей',
