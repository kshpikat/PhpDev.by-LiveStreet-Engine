...
return array(
    ...
    'adm_set_acl_create_talk_limit_time_rating' => 'Рейтинг, выше которого перестаёт действовать ограничение по времени на отправку внутренней почты',
    'adm_set_acl_create_talk_comment_limit_time' => 'Время (сек) между отправкой внутренней почты',
    'adm_set_acl_create_talk_comment_limit_time_rating' => 'Рейтинг, выше которого перестаёт действовать ограничение по времени на отправку внутренней почты',
