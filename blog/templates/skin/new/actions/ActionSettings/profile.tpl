...
{/literal}
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<p>
					...
					<input type="text" class="w100p" name="mail" id="mail" value="{$oUserCurrent->getMail()|escape:'html'}"/><br />
				...
				<p>
					...
					<label for="password_confirm">{$aLang.settings_profile_password_confirm}:</label><br /><input type="password" class="w300" id="password_confirm"	name="password_confirm" value=""/>
				</p>
