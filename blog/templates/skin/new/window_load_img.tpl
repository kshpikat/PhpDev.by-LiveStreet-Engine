...
<div class="login-popup upload-image" id="window_load_img">
	...
	<div class="content">
		<form method="POST" action="" enctype="multipart/form-data" id="form_upload_img" >
			...
			<p>
				<label for="img_file">{$aLang.uploadimg_file}:</label><br />
				<input type="file" name="img_file" value="" class="w100p" /></p>
			<p>
				<label for="img_url">{$aLang.uploadimg_url}:</label><br />
				<input type="text" name="img_url" value="http://" class="w100p"/>
			</p>
			{hook run="uploadimg_source"}
			<p>
				<label for="align">{$aLang.uploadimg_align}:</label><br />				
			...
			<p style="margin-bottom: 20px;">
				<label for="title">{$aLang.uploadimg_title}:</label><br />
			...
			<input type="button" value="{$aLang.uploadimg_cancel}"
