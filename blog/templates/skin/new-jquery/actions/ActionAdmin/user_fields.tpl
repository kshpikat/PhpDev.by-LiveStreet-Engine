...
<div class="userfield-form jqmWindow" id="userfield_form">
	...
	<input type="button" value="{$aLang.user_field_add}" class="button" onclick="ls.userfield.applyForm(); return false;" />
	<input type="button" value="{$aLang.user_field_cancel}" class="button jqmClose" />
</div>
